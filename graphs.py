...
plt.figure()
df['Categoria'].value_counts().plot(kind='bar', color='skyblue', edgecolor='black')
...
df['Assunto'].value_counts().plot(kind='bar', color='skyblue', edgecolor='black')
plt.xlabel('Assunto')
plt.ylabel('Ocorrências')
plt.xticks(rotation=45)
plt.tight_layout()
...
plt.figure()
df['Área de Negócio'].value_counts().plot(kind='bar', color='skyblue', edgecolor='black')
